...
variable "additional_g_service_ranges" {
  description = "Additional CIDR range (/16 advised) for Google services producers (like CloudSQL, Firebase, etc) in private subnet of the VPC. See https://cloud.google.com/vpc/docs/configure-private-services-access#ip_address_range_size."
  type        = list(string)
  default     = []
}